...
export function Aggregation() {
  return (
    <section className="py-20 md:py-32 lg:py-40 bg-gradient-to-b from-accent-50 to-white">
      <Container>
        {/* Section Label */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="recipe-card bg-white rounded-3xl p-6 shadow-xl border border-accent-200">
          ...
          <div>
            ...
            <div className="space-y-3">
              {/* Produce */}
              <div className="grocery-item bg-white rounded-xl shadow-md p-4 border-l-4 border-accent-500 hover:shadow-lg transition-all">
              ...
              {/* Dairy */}
              <div className="grocery-item bg-white rounded-xl shadow-md p-4 border-l-4 border-primary-400 hover:shadow-lg transition-all">
                <div className="flex items-center gap-3">
